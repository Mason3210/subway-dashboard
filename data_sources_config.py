...
INTERNATIONAL_SOURCES = [
    ...
    },
    {
        "name": "RSSB (英国铁路安全标准局)",
        "city": "英国",
        "url": "https://www.rssb.co.uk",
        "weibo": "",
        "wechat": "",
    },
    {
        "name": "CER (欧洲铁路和基础设施公司共同体)",
        "city": "欧洲",
        "url": "https://www.cer.be",
        "weibo": "",
        "wechat": "",
    },
    {
        "name": "TRB (美国交通运输研究委员会)",
        "city": "美国",
    ...
    },
    {
        "name": "IRSC (国际铁路安全理事会)",
        "city": "国际",
        "url": "https://www.international-railwaysafety-council.com",
        "weibo": "",
        "wechat": "",
    },
    {
...
SOCIAL_MEDIA_SOURCES = {
    "weibo": [
        ...
        {"name": "佛山地铁", "uid": "", "type": "official"},
        {"name": "南宁轨道交通", "uid": "", "type": "official"},
